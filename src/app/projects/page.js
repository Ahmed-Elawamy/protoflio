...
const projects = [
  ...
  {
    id: 11,
    title: "Landing Page For VR",
    description:
      "Futuristic landing page UI with clear UX, bold visual identity, 3D elements, and strong CTA for conversions.",
    image: "/vr.png",
    tech: ["HTML", "CSS", "JS"],
    codeLink: "https://github.com/Ahmed-Elawamy/landing-page",
    demoLink: "https://ahmed-elawamy.github.io/landing-page/",
  },
    ...
    <AnimatedSection>
      <section className="py-16">
        <div className="container mx-auto px-4">
          {/* Head */}
          <div className="mb-10">
            <h2 className="text-3xl font-bold mb-3">Selected Works</h2>
            <p className="text-[#697183] max-w-xl">
              A curated selection of web applications, experiments, and
              open-source contributions built with modern technologies.
            </p>
          </div>
